RegisterCommand("radio", function()
    ...
    -- local _mainMenu = NativeUI.CreateMenu("Radio", "~b~Select TokoVoip radio", 0, 0) -- Description is not working? Getting a value is `nil` here.
	local _mainMenu = NativeUI.CreateMenu("Radio", nil, 0, 0)
